...
public class Submit {
  ...
  private String challenge_url() {
    return "https://stanford.coursera.org/cs124-002/assignment/challenge";

  }

  private String submit_url() {
    return "https://stanford.coursera.org/cs124-002/assignment/submit";
  }

  // takes list of objects, returns "[s1, s2, s3, ..., sn]"
  // where si is list[i].toString()
  protected String join(List<? extends Object> list) {
    if (list == null) {
      return "[]";
    }
